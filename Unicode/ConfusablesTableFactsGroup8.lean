...
theorem mappingsFactGroup8_chain :
  ...
  simp only [List.all_append, mappingsChunk80_chain, mappingsChunk81_chain, mappingsChunk82_chain, mappingsChunk83_chain, mappingsChunk84_chain, mappingsChunk85_chain, mappingsChunk86_chain, mappingsChunk87_chain, mappingsChunk88_chain, mappingsChunk89_chain, Bool.and_true]

theorem mappingsFactGroup8_expansion :
    mappingsFactGroup8.all (expansionEntryUnderBound 18) = true := by
  unfold mappingsFactGroup8
  simp only [List.all_append, mappingsChunk80_expansion, mappingsChunk81_expansion, mappingsChunk82_expansion, mappingsChunk83_expansion, mappingsChunk84_expansion, mappingsChunk85_expansion, mappingsChunk86_expansion, mappingsChunk87_expansion, mappingsChunk88_expansion, mappingsChunk89_expansion, Bool.and_true]
