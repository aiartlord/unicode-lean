/-
  Unicode.Generated.BIP39.Korean

  BIP-39 Korean wordlist (2,048 words) parsed from
  `Unicode/Ucd/BIP39/korean.txt`.  The file is byte-identical to
  the publication at
  `https://github.com/bitcoin/bips/blob/master/bip-0039/korean.txt`
  and pinned in `Unicode/Ucd/BIP39/SHA256SUMS`.
-/

namespace Unicode.Generated.BIP39.Korean

/-- Raw wordlist text embedded at compile time. -/
def rawText : String := include_str "../../Ucd/BIP39/korean.txt"
...
end Unicode.Generated.BIP39.Korean
