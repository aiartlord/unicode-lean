...
def foldingsChunk0 : List (Nat × List Nat) := [
...
def foldingsChunk1 : List (Nat × List Nat) := [
...
def foldingsChunk2 : List (Nat × List Nat) := [
...
def foldingsChunk3 : List (Nat × List Nat) := [
...
def foldingsChunk4 : List (Nat × List Nat) := [
...
def foldingsChunk5 : List (Nat × List Nat) := [
...
def foldingsChunk6 : List (Nat × List Nat) := [
...
def foldingsChunk7 : List (Nat × List Nat) := [
...
def foldingsChunk8 : List (Nat × List Nat) := [
...
def foldingsChunk9 : List (Nat × List Nat) := [
...
def foldingsChunk10 : List (Nat × List Nat) := [
...
def foldingsChunk11 : List (Nat × List Nat) := [
...
def foldingsChunk12 : List (Nat × List Nat) := [
...
def foldingsChunk13 : List (Nat × List Nat) := [
...
def foldingsChunk14 : List (Nat × List Nat) := [
...
def foldingsChunk15 : List (Nat × List Nat) := [
...
def foldingsChunk16 : List (Nat × List Nat) := [
...
def foldingsChunk17 : List (Nat × List Nat) := [
...
def foldingsChunk18 : List (Nat × List Nat) := [
...
def foldingsChunk19 : List (Nat × List Nat) := [
...
def foldingsChunk20 : List (Nat × List Nat) := [
...
def foldingsChunk21 : List (Nat × List Nat) := [
...
def foldingsChunk22 : List (Nat × List Nat) := [
...
def foldingsChunk23 : List (Nat × List Nat) := [
...
def foldingsChunk24 : List (Nat × List Nat) := [
...
def foldings : List (Nat × List Nat) :=
  foldingsList

/-- The source column of the case-folding table, in table order. -/
def sourceCodepoints : List Nat := [
...
theorem sourceCodepoints_count : sourceCodepoints.length = 1585 := by decide
...
def lookupRaw? (cp : Nat) : Option (List Nat) :=
...
def cfParseRow (line : String) : Option (Nat × List Nat) :=
  ...
  if status == "C" || status == "F" then
    ...
    some (cfHex (cfTrim fields[0]!), mapping)
  else none

/-- Fresh parse of the pinned source, used only by the drift gate. -/
def foldingsListParsed : List (Nat × List Nat) :=
