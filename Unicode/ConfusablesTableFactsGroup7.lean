...
theorem mappingsFactGroup7_chain :
  ...
  simp only [List.all_append, mappingsChunk70_chain, mappingsChunk71_chain, mappingsChunk72_chain, mappingsChunk73_chain, mappingsChunk74_chain, mappingsChunk75_chain, mappingsChunk76_chain, mappingsChunk77_chain, mappingsChunk78_chain, mappingsChunk79_chain, Bool.true_and, Bool.and_true]

theorem mappingsFactGroup7_expansion :
    mappingsFactGroup7.all (expansionEntryUnderBound 18) = true := by
  unfold mappingsFactGroup7
  simp only [List.all_append, mappingsChunk70_expansion, mappingsChunk71_expansion, mappingsChunk72_expansion, mappingsChunk73_expansion, mappingsChunk74_expansion, mappingsChunk75_expansion, mappingsChunk76_expansion, mappingsChunk77_expansion, mappingsChunk78_expansion, mappingsChunk79_expansion, Bool.true_and, Bool.and_true]
