...
spl_autoload_register(static function (string $class): void {
    $shared = [
        ...
        'UnicodePhp\\Security\\Identity\\EastAsianWidth' => __DIR__ . '/Security/Identity/Ucd.php',
        ...
        'UnicodePhp\\Security\\Display\\SourceDisplayDivergenceClassification' => __DIR__ . '/Security/Display/SourceDisplayDivergence.php',
        'UnicodePhp\\Security\\Display\\SourceDisplayDivergenceVerdict' => __DIR__ . '/Security/Display/SourceDisplayDivergence.php',
        'UnicodePhp\\Security\\Display\\SourceDisplayDivergence' => __DIR__ . '/Security/Display/SourceDisplayDivergence.php',
        'UnicodePhp\\Security\\Display\\FieldDirection' => __DIR__ . '/Security/Display/RtlInjection.php',
        'UnicodePhp\\Security\\Display\\RtlInjectionVerdict' => __DIR__ . '/Security/Display/RtlInjection.php',
        'UnicodePhp\\Security\\Display\\RtlInjection' => __DIR__ . '/Security/Display/RtlInjection.php',
        'UnicodePhp\\Security\\Boundary\\AdmissibilityFormDriftSubThreat' => __DIR__ . '/Security/Boundary/AdmissibilityFormDrift.php',
        'UnicodePhp\\Security\\Boundary\\AdmissibilityFormDriftClassification' => __DIR__ . '/Security/Boundary/AdmissibilityFormDrift.php',
        'UnicodePhp\\Security\\Boundary\\AdmissibilityFormDriftVerdict' => __DIR__ . '/Security/Boundary/AdmissibilityFormDrift.php',
        'UnicodePhp\\Security\\Boundary\\AdmissibilityFormDrift' => __DIR__ . '/Security/Boundary/AdmissibilityFormDrift.php',
