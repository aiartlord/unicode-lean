...
| Family (Lean module) | rust | python | cpp | go | jvm | ts | dotnet | swift | zig | haskell | ruby | lua | php | elixir | erlang |
|---|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
| TagBlockPayload | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
...
| cobol | Native GnuCOBOL scanner, UTF-8/UTF-16/UTF-32 decode checks, shared detector/policy/verdict fixture harness, form vectors, Bip39Canonical vectors, vendored-data parity pass, and `nix build .#unicode-cobol`. Variation-pair, Default_Ignorable, Scripts, DerivedBidiClass, and confusable-source lookups are generated from vendored UCD data. Homoglyph target skeletons, normalization/casing expansion, and full BIP39 wordlist internals are still bounded, so it is not counted in the matrix yet. | no | Replace the remaining bounded internals with full data-backed detector logic before counting as a vouched 16/27 port. |
